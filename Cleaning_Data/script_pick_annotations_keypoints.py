...
if __name__ == "__main__":
  ...
  coco_annotation_dir = os.path.join(this_dir, 'annotations') 
  ...
  json_train_file = '{:s}/person_keypoints_{:s}.json'.format(coco_annotation_dir, 'train2014')
  print("Loading training annotations from %s"%(format(json_train_file)))
  json_train = json.load(open(json_train_file, 'r'))

  json_val_file = '{:s}/person_keypoints_{:s}.json'.format(coco_annotation_dir, 'val2014')
  ...
  json_trainval_file = '{:s}/person_keypoints_{:s}.json'.format(coco_annotation_dir, 'trainval2014')
  ...
  json_trainval = json.load(open('{:s}/person_keypoints_{:s}.json'.format(coco_annotation_dir, 'trainval2014'), 'r'))
  ...
  vcoco = os.path.join(vcoco_annotation_dir, 'person_keypoints_vcoco_all_2014.json')
