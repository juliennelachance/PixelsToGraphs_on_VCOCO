...
if __name__ == "__main__":
  ...
  json_in = json.load(open('{:s}/testout_{:s}.json'.format(this_dir, 'Dec18'), 'r'))

  # The data splits (lists of image indices):
  vcoco_train = np.loadtxt(os.path.join(this_dir, 'vcoco_trainval.ids'))[:,np.newaxis]
